...
cat <<-EOF >${MKDOCS}
site_name: ACA-Py Mininal Examples
repo_name: openwallet-foundation/acapy-minimal-example
site_url: https://me.aca-py.org
repo_url: https://github.com/openwallet-foundation/acapy-minimal-example
theme:
  name: material
...
nav:
- Welcome:
    - ACA-Py Minimal Example: README.md
- Examples:
EOF

# Generate the per-example navigation entries
for d in examples/*/ ; do
  if [ ${d}  != "docs/" ] && [ -f ${d}README.md ] ; then
...
- Contributing:
    ...
    - Managing the ACA-Py Minimal Example Docs Site: DOCSITE.md
    - License: LICENSE.md
EOF
